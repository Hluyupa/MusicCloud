...
export default function PauseButton(props){
    ...
    <><svg className="background-pause-btn" width="37" height="55" viewBox="0 0 37 55" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="1" width="13" height="53" rx="6.5" fill={props.background}/>
        <rect x="23" y="1" width="13" height="53" rx="6.5" fill={props.background}/>
    </svg>
    ...
    return(
        <ButtonTemplate className="pause-btn" onClickFunc ={props.onClick}>
            {iconPauseBtn}
        </ButtonTemplate>
    );
